...
DEFAULT_REGISTRATION_FEE = Decimal(os.environ.get("DEFAULT_REGISTRATION_FEE", "60.00"))
DEFAULT_MONTHLY_FEE_4 = Decimal(os.environ.get("DEFAULT_MONTHLY_FEE_4", "100.00"))
DEFAULT_MONTHLY_FEE_8 = Decimal(os.environ.get("DEFAULT_MONTHLY_FEE_8", "160.00"))
DEFAULT_MONTHLY_FEE = DEFAULT_MONTHLY_FEE_4
